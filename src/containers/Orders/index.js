                        ...
                        <div>
                            ...
                            {orderItem.items.map((item, index) => (
                                <div className="value" key={index}>
                                    {`${item.productId.name} / Price : ${item.payablePrice} / Quantity : ${item.purchasedQty}`}
                                </div>
                            ))}
                        </div>
                        <div>
                            <span className="title">Total Price</span><br />
                            <div className="value">{orderItem.totalAmount}</div>
                        </div>
                        <div>
                        ...
                        <div className="orderTrack">
                            {orderItem.orderStatus.map((status) => (
                                <div className={`orderStatus ${status.isCompleted ? "active" : ""}`}>
                                    <div
                                        className={`point ${status.isCompleted ? "active" : ""}`}></div>
              ...
              <div className="orderStatus">
                ...
                <div className="orderInfo">
                  ...
                  <div className="date">Fri, 2020</div>
                        ...
                        // }}
                        >
                            <Button variant="success" onClick={() => onOrderUpdate(orderItem._id)}>confirm </Button>
                        </div>
                    </div>
                </Card>
            ))
